  ...
  return (
    <>
      ...
      <div className="flex min-h-[calc(100vh-65px)]">
        {/* Sidebar */}
        <aside className="w-80 border-r border-border p-6 bg-bg2 flex flex-col gap-6">
          <div>
          ...
          {hasSearched && !loading && leads.length > 0 && (
            <div className="bg-bg3 border border-border rounded-xl p-4 flex flex-col gap-3">
              <div className="flex justify-between text-xs">
                <span className="text-muted2">Leads found</span>
                <span className="text-green font-semibold">{leads.length} leads</span>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-muted2">With phone number</span>
                <span className="text-muted2">{leads.filter((l) => l.phone).length} / {leads.length}</span>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-muted2">Scraped from Google</span>
                <span className="text-muted2">{scrapedCount} businesses</span>
              </div>
            </div>
          )}
